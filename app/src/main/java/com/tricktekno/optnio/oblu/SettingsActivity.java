...
public class SettingsActivity extends Activity {
    ...
    public void onClick(View view){
        switch (view.getId()){
         ...
         /*   case R.id.zoomin:
                zoomScale+=zoomScale;
                img = Bitmap.createScaledBitmap(img,img.getWidth()+zoomScale,
                        img.getHeight()+zoomScale,false);
            ...
            case R.id.rotateclock:
                ...
                img = Bitmap.createBitmap(img , 0, 0, img.getWidth(), img.getHeight(), matrix1, true);
                PathDrawView.setGivenBackgroundBitmap(img);
                break;
